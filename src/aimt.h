...
/** 
 *
 * @example demo_sub2ind2D.c
 * This is an example of how to use the sub2ind2D function.
 */

/**
 *
 * @brief Converts subscripts into linear indices. 
 *
...
/** 
 *
 * @example demo_ind2sub2D.c
 * This is an example of how to use the ind2sub2D function.
 */

/**
 *
 * @brief Converts linear index into subscripts. 
 *
 * @param[in] arrayOfDimensions where each element represents the number of rows and 
 * columns respectively.
 * @param[in] dimensions is size of the @paramname{arrayOfDimensions} and 
